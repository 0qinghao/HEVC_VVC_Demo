...
while 1
    ...
    waitbar((time_hevc - sum(enc_time_hevc(1:i_hevc)))/enc_time_hevc(i_hevc+1), waitbar_hevc)
    waitbar((time_vvc - sum(enc_time_vvc(1:i_vvc)))/enc_time_vvc(i_vvc+1), waitbar_vvc)
